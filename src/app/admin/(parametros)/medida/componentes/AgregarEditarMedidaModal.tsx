...
interface AgregarEditarMedidaModalProps {
  medida: Medida | null
  isOpen: boolean
  onClose: () => void
  onSuccess: () => void
...
export function AgregarEditarMedidaModal({
  medida,
  isOpen,
  onClose,
  onSuccess,
}: AgregarEditarMedidaModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="overflow-y-auto max-h-screen">
        <DialogHeader>
          <DialogTitle>
            {medida ? 'Editar U./Medida' : 'Agregar U./Medida'}
          </DialogTitle>
        </DialogHeader>
        <Form {...form}>
